...
const i18n = {
  ru: {
    ...
    valueOneText: "Спокойный и точный анализ вашей энергии и потенциала",
    valueTwoTitle: "12 авторских модулей",
    valueTwoText: "Понятные сценарии для тела, денег, отношений и таро",
    valueThreeTitle: "Оплата онлайн",
    valueThreeText: "YooKassa для MVP, промокоды и защищенный доступ",
  ...
  en: {
    ...
    valueOneText: "A calm and precise look at your energy and potential",
    valueTwoTitle: "12 author modules",
    valueTwoText: "Clear scenarios for body, money, relationships and tarot",
    valueThreeTitle: "Online payments",
    valueThreeText: "YooKassa for MVP, promo codes and protected access",
